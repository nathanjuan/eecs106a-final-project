...
*/
//-------------------------------------------------------------------------------------------
#include "ay_util_msgs/SetPlanningSceneDiff.h"
#include "ay_util_msgs/GetTrajectoryValidity.h"
#include "ay_util_msgs/GetAllowedCollisionMatrix.h"
#include "ay_util_msgs/GetStateValidity.h"
//-------------------------------------------------------------------------------------------
#include <ros/ros.h>
...
bool SetPlanningSceneDiff(ay_util_msgs::SetPlanningSceneDiff::Request &req, ay_util_msgs::SetPlanningSceneDiff::Response &res)
{
...
bool GetStateValidity(ay_util_msgs::GetStateValidity::Request &req, ay_util_msgs::GetStateValidity::Response &res)
{
  /*
...
bool GetTrajectoryValidity(ay_util_msgs::GetTrajectoryValidity::Request &req, ay_util_msgs::GetTrajectoryValidity::Response &res)
{
  /*
...
bool GetAllowedCollisionMatrix(ay_util_msgs::GetAllowedCollisionMatrix::Request &req, ay_util_msgs::GetAllowedCollisionMatrix::Response &res)
{
